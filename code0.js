...
gdjs.Intro1Code.asyncCallback16821340 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(3), (runtimeScene) => (gdjs.Intro1Code.asyncCallback16821340(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.Intro1Code.asyncCallback16821844 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.Intro1Code.localVariables);
...
asyncObjectsList.backupLocalVariablesContainers(gdjs.Intro1Code.localVariables);
/* Don't save btn_comecar as it will be provided by the parent asyncObjectsList. */
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.Intro1Code.asyncCallback16821844(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.Intro1Code.asyncCallback16821412 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.Intro1Code.localVariables);
...
/* Don't save btn_comecar as it will be provided by the parent asyncObjectsList. */
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.Intro1Code.asyncCallback16821412(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.Intro1Code.asyncCallback16820732 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.Intro1Code.localVariables);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.Intro1Code.asyncCallback16820732(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.Intro1Code.asyncCallback16823324 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.Intro1Code.localVariables);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(gdjs.Intro1Code.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.Intro1Code.asyncCallback16823324(runtimeScene, asyncObjectsList)));
}
}
