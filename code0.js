...
gdjs.Intro1Code.asyncCallback20765884 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(3), (runtimeScene) => (gdjs.Intro1Code.asyncCallback20765884(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.Intro1Code.asyncCallback20765652 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.Intro1Code.localVariables);
...
asyncObjectsList.backupLocalVariablesContainers(gdjs.Intro1Code.localVariables);
/* Don't save btn_comecar as it will be provided by the parent asyncObjectsList. */
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.Intro1Code.asyncCallback20765652(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.Intro1Code.asyncCallback20765116 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.Intro1Code.localVariables);
...
/* Don't save btn_comecar as it will be provided by the parent asyncObjectsList. */
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.Intro1Code.asyncCallback20765116(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.Intro1Code.asyncCallback20764772 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.Intro1Code.localVariables);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.Intro1Code.asyncCallback20764772(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.Intro1Code.asyncCallback20766748 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.Intro1Code.localVariables);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(gdjs.Intro1Code.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.Intro1Code.asyncCallback20766748(runtimeScene, asyncObjectsList)));
}
}
